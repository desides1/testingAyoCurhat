                    ...
                    <div class="container ml-3 mr-4">
                        <div class="row">
                            <div class="col-lg-5 mx-0 text-center">
                                <img src="{{ asset('assets/images/pages/emergency-call.png') }}"
                                    class="img-fluid rounded mb-4" alt="Responsive image"
                            ...
                            <div class="col-lg-6 ml-5 mt-3">
                                ...
                                <p class="mr-4 mb-4">Lakukan panggilan darurat ketika anda membutuhkan pelayanan sesegera
                                    mungkin. Kami akan melakukan yang terbaik untuk anda, kepuasan anda adalah prioritas
                                    bagi kami.</p>
